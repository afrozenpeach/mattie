...
export type Morph =
  ...
  | BlogsGroupBy
  | BlogsConnectionId
  | BlogsConnectionCreated_At
  | BlogsConnectionUpdated_At
  | BlogsConnectionTitle
  | BlogsConnectionSubtitle
  | BlogsConnectionPrimaryPhoto
  | BlogsConnectionContent
  | BlogsConnectionUrl
  | BlogsConnectionPublished_At
  | CreateBlogPayload
  | UpdateBlogPayload
  | DeleteBlogPayload
  | BoardGames
  | BoardGamesConnection
  | BoardGamesAggregator
  | BoardGamesGroupBy
  | BoardGamesConnectionId
  | BoardGamesConnectionCreated_At
  | BoardGamesConnectionUpdated_At
  | BoardGamesConnectionTitle
  | BoardGamesConnectionSubtitle
  | BoardGamesConnectionPrimaryPhoto
  | BoardGamesConnectionContent
  | BoardGamesConnectionStatus
  | BoardGamesConnectionPublished_At
  | CreateBoardGamePayload
  | UpdateBoardGamePayload
  | DeleteBoardGamePayload
  | DevelopmentProjects
  | DevelopmentProjectsConnection
  | DevelopmentProjectsAggregator
  | DevelopmentProjectsGroupBy
  | DevelopmentProjectsConnectionId
  | DevelopmentProjectsConnectionCreated_At
  | DevelopmentProjectsConnectionUpdated_At
  | DevelopmentProjectsConnectionTitle
  | DevelopmentProjectsConnectionSubtitle
  | DevelopmentProjectsConnectionPrimaryPhoto
  | DevelopmentProjectsConnectionContent
  | DevelopmentProjectsConnectionStatus
  | DevelopmentProjectsConnectionPublished_At
  | CreateDevelopmentProjectPayload
  | UpdateDevelopmentProjectPayload
  | DeleteDevelopmentProjectPayload
  | UploadFile
    ...
    Array<
      Maybe<
        { __typename?: 'BlogPost' } & Pick<
          BlogPost,
          'id' | 'postDate' | 'title' | 'featured' | 'slug'
        > & {
            headerPhoto?: Maybe<
              { __typename?: 'UploadFile' } & Pick<UploadFile, 'id' | 'name'>
            >
          }
      >
    >
...
export class SinglePostGQL extends Apollo.Query<
  SinglePostQuery,
